...
namespace DomainAI.Agents.Reporting.Api.Consumers;
...
public sealed class ExecuteAgentCommandConsumer : ExecuteAgentCommandConsumerBase
{
    ...
    protected override string TargetAgentId => "reporting-agent";
        ...
        DomainAI.Shared.Contracts.Messages.ExecuteAgentCommand command, CancellationToken ct)
    {
        ...
        return await _mediator.Send(
            new DomainAI.Agents.Reporting.Application.Commands.ExecuteAgentCommand(request), ct);
    }
}
